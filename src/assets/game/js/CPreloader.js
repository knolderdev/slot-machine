function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "assets/game/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "assets/game/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "assets/game/sprites/but_start.png");
